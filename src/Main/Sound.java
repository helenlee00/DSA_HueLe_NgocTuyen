...
public class Sound {
    ...
    public Sound () {
        ...
        soundURL[0] = getClass().getResource("/sound/pacman.wav");
        soundURL[1] = getClass().getResource("/sound/receivedamage.wav");
        soundURL[2] = getClass().getResource("/sound/swingweapon.wav");
        soundURL[3] = getClass().getResource("/sound/cursor.wav");
        soundURL[4] = getClass().getResource("/sound/burning.wav");
